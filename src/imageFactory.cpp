...
std::vector<cv::KeyPoint> ImageFactory::detKeypoints(cv::Mat& img)
{
...
std::vector<cv::KeyPoint> ImageFactory::keyPointsNMS(std::vector<cv::KeyPoint> &&keypoints,
...
cv::Mat ImageFactory::descKeypoints(std::vector<cv::KeyPoint> &keypoints, cv::Mat &img)
{
  cv::Mat descriptors;
...
std::vector<cv::DMatch> ImageFactory::matchDescriptors(cv::Mat &desc_source, cv::Mat &desc_ref)
{
...
cv::Mat ImageFactory::visualizeMatches(const cv::Mat &image0, const cv::Mat &image1, const std::vector<cv::KeyPoint> &keypoints0,
...
std::tuple<std::vector<cv::Point2f>, std::vector<cv::Point2f>, std::vector<uchar>>
   ImageFactory::calculateOpticalFlow(const cv::Mat &image0, const cv::Mat &image1, const std::vector<cv::KeyPoint> &keypoints0)
{
...
cv::Mat ImageFactory::visualizeOpticalFlow(const cv::Mat &image1, const std::vector<cv::Point2f> &keypoints0_2f,
...
cv::Mat ImageFactory::visualizeOpticalFlow(const cv::Mat &image1, const std::vector<cv::KeyPoint> &keypoints0,
                               const std::vector<cv::KeyPoint> &keypoints1, const std::vector<cv::DMatch> &matches)
{
  cv::Mat image1_color = image1.clone();
  cv::cvtColor(image1_color, image1_color, cv::COLOR_GRAY2BGR);
