...
public:
  ...
  ScanRegistration(): nh("scanRegistration")
  {
  ...
  void init()
  {
    ...
    laserCloudFull = boost::make_shared<pcl::PointCloud<PointType>>();
  }
  ...
  void cloudOut(pcl::PointCloud<PointType>::Ptr &laserCloudOut, pcl::PointCloud<PointType>::Ptr &laserCloudSharp,  
      pcl::PointCloud<PointType>::Ptr &laserCloudFlat)
  {

    laserCloudOut = this->laserCloud;
    laserCloudSharp = this->cornerPointsSharp;
    laserCloudFlat = this->surfPointsFlat;
